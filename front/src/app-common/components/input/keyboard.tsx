...
export const Keyboard = (props: KeyboardProps) => {
  ...
  const letters: {
    ...
    '*en': {normal: t('Enter'), shift: t('Enter')},
    '*sh': {normal: t('caps'), shift: t('CAPS')},
    '*c': {normal: 'C', shift: 'C'},
    '*space': {normal: t('Space'), shift: t('Space')},
    '*ok': {normal: t('OK'), shift: t('OK')},
    '*cancel': {normal: t('Cancel'), shift: t('Cancel')}
  };
