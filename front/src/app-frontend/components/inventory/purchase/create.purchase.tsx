      ...
      >
        <form onSubmit={handleSubmit(savePurchase)}>
          <div className="grid lg:grid-cols-4 gap-4 mb-3 md:grid-cols-3 sm:grid-cols-1">
            ...
            <div>
              <label htmlFor="purchaseNumber">{t("Purchase No.")}</label>
            ...
            <div>
              <label htmlFor="purchase-mode">{t("Purchase using")}</label>
              ...
              <Controller
                render={(props) => (
                  <ReactSelect
                    ...
                    options={[
                      {label: t('Items list'), value: 'Items list'},
                      {label: t('Purchase order'), value: 'Purchase order'},
                    ]}
                    defaultValue={{label: t('Items list'), value: 'Items list'}}
            ...
            {poMode ? (
              <div>
                <label htmlFor="purchaseOrder">{t("Select a Purchase Order")}</label>
                <Controller
                  render={(props) => (
              ...
              <>
                <div>
                  <label htmlFor="supplier">{t("Select a supplier")}</label>
                  <Controller
                    render={(props) => (
                      <div className="input-group">
                        <ReactSelect
                ...
                <div>
                  <label htmlFor="items">{t("Select items")}</label>
                  <div className="input-group">
                    <ReactSelect
                      onChange={(value) => {
                        if (value) {
          ...
          <div className="mb-3">
            ...
            <div className={
              ...
              {po && <div className="font-bold">{t("Quantity requested")}</div>}
              <div className="font-bold">{t("Quantity")}</div>
              <div className="font-bold">{t("Unit Cost")}</div>
              <div className="font-bold">{t("Total Cost")}</div>
              <div className="font-bold">{t("Comments")}</div>
              <div className="font-bold">{t("Remove?")}</div>
            </div>
          ...
          <div className="mb-3">
            <label htmlFor="paymentType">{t("Select payment type")}</label>
            <div className="w-96">
              <Controller
                render={(props) => (
                  <ReactSelect
          ...
          <Button type="submit" disabled={creating} className="btn btn-primary">{t("Save")}</Button>
        </form>
      </Modal>
        ...
        <div className="border rounded-2xl border-gray-300 bg-gray-50 p-3 mb-3">
          {item.variants.length > 0 && (
            <div className="grid grid-cols-5 gap-3 px-5">
              ...
              <div className="font-bold">{t("Variant cost")}</div>
              <div className="font-bold">{t("Variant quantity")}</div>
              <div className="font-bold">{t("Total cost")}</div>
              <div className="font-bold">{t("Remove variant?")}</div>
            </div>
          )}
            ...
            <div className="grid grid-cols-5 gap-3 mb-1 px-5 hover:bg-gray-200">
              ...
              <div className="inline-flex items-center">
                <ConfirmAlert
                  ...
                  title={`${t("Remove")} ${item.item.name} > ${variant.attributeValue}?`}
                  confirmText={t("Remove")}
                >
                  <button className="btn btn-danger" type="button">
                    <FontAwesomeIcon icon={faRemove}/>
