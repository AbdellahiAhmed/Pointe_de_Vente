        ...
        return (
          <>
            ...
            <ConfirmAlert
              ...
              description={info.row.original.isActive ? t('Are you sure to deactivate this brand?') : t('Are you sure to activate this brand?')}
            >
        ...
        buttons={[
          {
            html: (
              <Button
                ...
                <FontAwesomeIcon icon={faPlus} className="me-2"/> {t("Brand")}
              </Button>
            ),
          },
        ]}
