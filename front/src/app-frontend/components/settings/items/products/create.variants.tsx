  ...
  return (
    <div>
      <div className="input-group w-auto">
        ...
        <Button type="button" variant="primary" onClick={addGroup}>{t("Add variant group")}</Button>
      </div>
      ...
      {variants.length > 0 && (
        <div>
          <Input onChange={(event) => setFilter(event.target.value)} value={filter} placeholder={t("Filter variants")} />
        </div>
      )}
