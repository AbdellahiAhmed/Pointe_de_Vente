        ...
        <div className="card w-96 flex flex-col justify-center">
          <div className="card-body">
            <div className="pt-4 pb-2">
              <h5 className="card-title text-center pb-0 fs-4">{t('Reset your password')}</h5>
            </div>
            ...
            <form onSubmit={handleSubmit(submitForm)} className="flex flex-col gap-5">
              ...
              <div className="flex flex-row justify-between">
                <button type="submit" disabled={isLoading}
                        className="w-100 btn btn-primary">{t('Reset')}</button>
                <Link to={LOGIN} className="text-white">{t('Login')}</Link>
              </div>
            </form>
          </div>
        </div>
